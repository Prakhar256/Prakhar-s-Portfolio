      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              Hello guys! My name is Prakhar Jain,  I am currently a 3rd year undergraduate from IIIT Allahabad pursuing my Bachelors of Technology in Electronics and Communication Engineering.
            </p>
            {/* BIOGRAPHY QUOTE */}
            <span className="italic">
              I am tech enthusiast and kind of a academic guy too. Currently my overall CGPA is 8.93 which puts me in top 3 rank holder of our batch.
            </span>
            {/* BIOGRAPHY SIGN SVG*/}
            ...
            >
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                    Working on a Research project based on Shoreline detection using POLSAR under Dr. Himanshu Maurya.
                  </div>
                  {/* JOB DATE */}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="p-3 text-sm italic">
                    I worked on React-based application development,
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  {/* JOB DESC */}
                  <div className="mt-5 p-3 text-sm italic">
